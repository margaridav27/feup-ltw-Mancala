class GameHistory {
    ...
    static updateLocalScores(game) {
        ...
        this.localScores.sort(
            (p1, p2) => (
                p1.totalScore < p2.totalScore) ? 1 : -1
            );
    }
    ...
    static renderLocalScores() {
        /* TODO: uncomment to test if local scores are displaying correctly
        this.localGames.forEach(game => {
    ...
    static addGameToHistory(game) {
        ...
        this.games.push(gameHistoryCell);

        this.updateLocalScores(gameHistoryCell);
    }
}